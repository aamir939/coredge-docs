...
<table style={{fontSize: '0.85rem', width: 'auto', borderCollapse: 'collapse'}}>
  ...
  <tbody>
    ...
    <tr><td style={{padding: '3px 12px'}}><strong>Management Layer</strong></td><td style={{padding: '3px 12px'}}>Handles cluster lifecycle through CAPI with Managed Control Plane</td><td style={{padding: '3px 12px'}}>Cluster API, Provisioning, Scaling, Upgrades</td></tr>
  </tbody>
</table>
...
|---------------|---------|
| **Kubernetes Versions** | v1.33.7, v1.33.8, v1.34.0, v1.34.1, v1.35.0, v1.35.1 (CNCF Certified) |
