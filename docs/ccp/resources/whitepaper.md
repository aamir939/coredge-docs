...
<table style={{fontSize: '0.85rem', width: 'auto', borderCollapse: 'collapse'}}>
  ...
  <tbody>
    <tr><td style={{padding: '3px 12px'}}>Cirrus Cloud Platform (CCP)</td><td style={{padding: '3px 12px'}}>Cloud Management Platform — the top-layer self-service and governance platform that customers and operators interact with directly.</td></tr>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 390" width="100%" style={{maxWidth:"760px"}} font-family="Arial, sans-serif">
  ...
  <rect x="425" y="112" width="280" height="52" rx="8" fill="url(#ccp1)" stroke="#059669" stroke-width="1.5"/>
  ...
  <rect x="425" y="198" width="280" height="52" rx="8" fill="url(#ccp2)" stroke="#34d399" stroke-width="1.5"/>
  ...
  <rect x="425" y="284" width="280" height="52" rx="8" fill="url(#ccp3)" stroke="#a78bfa" stroke-width="1.5"/>
  ...
  <defs>
    ...
    <linearGradient id="ccp1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#0e9f6e"/></linearGradient>
    <linearGradient id="ccp2" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#0e9f6e"/><stop offset="100%" stop-color="#10b981"/></linearGradient>
    <linearGradient id="ccp3" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#7c3aed"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient>
  </defs>
</svg>
...
[Download PDF](/downloads/whitepapers/CCP_Whitepaper.pdf)