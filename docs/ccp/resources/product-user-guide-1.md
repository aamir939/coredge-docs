...
Cirrus Cloud Platform (CCP), a Cloud Self-Service Portal that captures the overall product specifications to create a comprehensive cloud offering for your business and provide seamless infrastructure provisioning, monitoring, and management of cloud services. CCP platform is a cloud orchestrator or manager designed to provide hyper-scaler-like capabilities to OpenStack and Kubernetes-based deployments. The purpose is to provide better cloud services in terms of features, stability, and performance. Empower your team with the ability to effortlessly deploy, monitor, and control your infrastructure, ensuring optimal performance and efficiency.
...
The scope of this document is to explain the usability and functionality of CCP admin console to its users.


# Dashboard

CCP dashboard is designed for seamless management and complete control. The Admin portal empowers you to oversee users, roles, and resources effortlessly, with secure access and real-time insights that simplify administration and enhance operational efficiency.
...
![image5.png](../../../static/img/ccp/user-guides/admin/image5.png)
...
![image6.png](../../../static/img/ccp/user-guides/admin/image6.png)
...
- Log in to the CCP admin portal.
...
![image7.png](../../../static/img/ccp/user-guides/admin/image7.png)
...
![image8.png](../../../static/img/ccp/user-guides/admin/image8.png)
...
![image9.png](../../../static/img/ccp/user-guides/admin/image9.png)

![image10.png](../../../static/img/ccp/user-guides/admin/image10.png)

![image11.png](../../../static/img/ccp/user-guides/admin/image11.png)

- Additional information provides firewall and VDOM details.

![image12.png](../../../static/img/ccp/user-guides/admin/image12.png)

- If a firewall or VDOM is no longer needed, you can delete it using delete button.

![image13.png](../../../static/img/ccp/user-guides/admin/image13.png)

![image14.png](../../../static/img/ccp/user-guides/admin/image14.png)

- Click on a firewall name, it provides firewall details and compute firewall details.

![image15.png](../../../static/img/ccp/user-guides/admin/image15.png)

- VDOM provides its overview and VPCs details.

![image16.png](../../../static/img/ccp/user-guides/admin/image16.png)
...
![image17.png](../../../static/img/ccp/user-guides/admin/image17.png)

![image18.png](../../../static/img/ccp/user-guides/admin/image18.png)
...
![image19.png](../../../static/img/ccp/user-guides/admin/image19.png)
...
![image20.png](../../../static/img/ccp/user-guides/admin/image20.png)
...
![image21.png](../../../static/img/ccp/user-guides/admin/image21.png)

![image22.png](../../../static/img/ccp/user-guides/admin/image22.png)
...
- Log in to the Fluid CCP admin platform.
...
![image23.png](../../../static/img/ccp/user-guides/admin/image23.png)

![image24.png](../../../static/img/ccp/user-guides/admin/image24.png)
...
![image25.png](../../../static/img/ccp/user-guides/admin/image25.png)
...
![image26.png](../../../static/img/ccp/user-guides/admin/image26.png)

![image27.png](../../../static/img/ccp/user-guides/admin/image27.png)
...
![image28.png](../../../static/img/ccp/user-guides/admin/image28.png)
...
![image29.png](../../../static/img/ccp/user-guides/admin/image29.png)

![image30.png](../../../static/img/ccp/user-guides/admin/image30.png)
...
![image31.png](../../../static/img/ccp/user-guides/admin/image31.png)
...
![image32.png](../../../static/img/ccp/user-guides/admin/image32.png)
...
![image33.png](../../../static/img/ccp/user-guides/admin/image33.png)

![image34.png](../../../static/img/ccp/user-guides/admin/image34.png)
...
![image35.png](../../../static/img/ccp/user-guides/admin/image35.png)
...
![image36.png](../../../static/img/ccp/user-guides/admin/image36.png)

- Once a role is created, you can view the permission it is assigned to. Permissions like read, create, update, and so on.

![image37.png](../../../static/img/ccp/user-guides/admin/image37.png)

![image38.png](../../../static/img/ccp/user-guides/admin/image38.png)
...
![image39.png](../../../static/img/ccp/user-guides/admin/image39.png)

![image40.png](../../../static/img/ccp/user-guides/admin/image40.png)
...
![image41.png](../../../static/img/ccp/user-guides/admin/image41.png)
...
![image42.png](../../../static/img/ccp/user-guides/admin/image42.png)
...
![image43.png](../../../static/img/ccp/user-guides/admin/image43.png)
...
![image44.png](../../../static/img/ccp/user-guides/admin/image44.png)
...
![image45.png](../../../static/img/ccp/user-guides/admin/image45.png)
...
![image46.png](../../../static/img/ccp/user-guides/admin/image46.png)

![image47.png](../../../static/img/ccp/user-guides/admin/image47.png)

![image48.png](../../../static/img/ccp/user-guides/admin/image48.png)
...
![image49.png](../../../static/img/ccp/user-guides/admin/image49.png)
...
![image50.png](../../../static/img/ccp/user-guides/admin/image50.png)
...
![image51.png](../../../static/img/ccp/user-guides/admin/image51.png)

![image52.png](../../../static/img/ccp/user-guides/admin/image52.png)
...
![image53.png](../../../static/img/ccp/user-guides/admin/image53.png)

![image54.png](../../../static/img/ccp/user-guides/admin/image54.png)

- Click on the three dots, click on manage Init script, and click on update script.

![image55.png](../../../static/img/ccp/user-guides/admin/image55.png)
...
![image56.png](../../../static/img/ccp/user-guides/admin/image56.png)
...
![image57.png](../../../static/img/ccp/user-guides/admin/image57.png)
...
![image58.png](../../../static/img/ccp/user-guides/admin/image58.png)
...
![image59.png](../../../static/img/ccp/user-guides/admin/image59.png)

![image60.png](../../../static/img/ccp/user-guides/admin/image60.png)
...
![image61.png](../../../static/img/ccp/user-guides/admin/image61.png)

![image62.png](../../../static/img/ccp/user-guides/admin/image62.png)
...
![image63.png](../../../static/img/ccp/user-guides/admin/image63.png)
...
![image64.png](../../../static/img/ccp/user-guides/admin/image64.png)

![image65.png](../../../static/img/ccp/user-guides/admin/image65.png)

![image66.png](../../../static/img/ccp/user-guides/admin/image66.png)

![image67.png](../../../static/img/ccp/user-guides/admin/image67.png)

![image68.png](../../../static/img/ccp/user-guides/admin/image68.png)
...
![image69.png](../../../static/img/ccp/user-guides/admin/image69.png)

![image70.png](../../../static/img/ccp/user-guides/admin/image70.png)

![image71.png](../../../static/img/ccp/user-guides/admin/image71.png)

![image72.png](../../../static/img/ccp/user-guides/admin/image72.png)

![image73.png](../../../static/img/ccp/user-guides/admin/image73.png)
...
![image74.png](../../../static/img/ccp/user-guides/admin/image74.png)


### Update Availability Zones

Updating availability zones means to refresh, modify, or sync the list of Availability Zones in a CCP admin console.
...
![image75.png](../../../static/img/ccp/user-guides/admin/image75.png)

![image76.png](../../../static/img/ccp/user-guides/admin/image76.png)

![image77.png](../../../static/img/ccp/user-guides/admin/image77.png)
...
![image78.png](../../../static/img/ccp/user-guides/admin/image78.png)
...
![image79.png](../../../static/img/ccp/user-guides/admin/image79.png)

![image80.png](../../../static/img/ccp/user-guides/admin/image80.png)

![image81.png](../../../static/img/ccp/user-guides/admin/image81.png)
...
![image82.png](../../../static/img/ccp/user-guides/admin/image82.png)

![image83.png](../../../static/img/ccp/user-guides/admin/image83.png)

![image84.png](../../../static/img/ccp/user-guides/admin/image84.png)
...
![image85.png](../../../static/img/ccp/user-guides/admin/image85.png)
...
![image86.png](../../../static/img/ccp/user-guides/admin/image86.png)

![image87.png](../../../static/img/ccp/user-guides/admin/image87.png)
...
![image88.png](../../../static/img/ccp/user-guides/admin/image88.png)

![image89.png](../../../static/img/ccp/user-guides/admin/image89.png)

![image90.png](../../../static/img/ccp/user-guides/admin/image90.png)
...
![image91.png](../../../static/img/ccp/user-guides/admin/image91.png)

![image92.png](../../../static/img/ccp/user-guides/admin/image92.png)

![image93.png](../../../static/img/ccp/user-guides/admin/image93.png)
...
![image94.png](../../../static/img/ccp/user-guides/admin/image94.png)
...
![image95.png](../../../static/img/ccp/user-guides/admin/image95.png)
...
![image96.png](../../../static/img/ccp/user-guides/admin/image96.png)
...
![image97.png](../../../static/img/ccp/user-guides/admin/image97.png)
...
![image98.png](../../../static/img/ccp/user-guides/admin/image98.png)
...
![image99.png](../../../static/img/ccp/user-guides/admin/image99.png)
...
![image100.png](../../../static/img/ccp/user-guides/admin/image100.png)
...
![image101.png](../../../static/img/ccp/user-guides/admin/image101.png)
...
![image102.png](../../../static/img/ccp/user-guides/admin/image102.png)

![image103.png](../../../static/img/ccp/user-guides/admin/image103.png)
...
![image104.png](../../../static/img/ccp/user-guides/admin/image104.png)

![image105.png](../../../static/img/ccp/user-guides/admin/image105.png)
...
![image106.png](../../../static/img/ccp/user-guides/admin/image106.png)

![image107.png](../../../static/img/ccp/user-guides/admin/image107.png)
...
![image110.png](../../../static/img/ccp/user-guides/admin/image110.png)

![image111.png](../../../static/img/ccp/user-guides/admin/image111.png)
...
![image112.png](../../../static/img/ccp/user-guides/admin/image112.png)

![image113.png](../../../static/img/ccp/user-guides/admin/image113.png)

![image114.png](../../../static/img/ccp/user-guides/admin/image114.png)

![image115.png](../../../static/img/ccp/user-guides/admin/image115.png)
...
![image116.png](../../../static/img/ccp/user-guides/admin/image116.png)

![image117.png](../../../static/img/ccp/user-guides/admin/image117.png)

![image118.png](../../../static/img/ccp/user-guides/admin/image118.png)

![image119.png](../../../static/img/ccp/user-guides/admin/image119.png)
...
![image120.png](../../../static/img/ccp/user-guides/admin/image120.png)
...
![image121.png](../../../static/img/ccp/user-guides/admin/image121.png)

![image122.png](../../../static/img/ccp/user-guides/admin/image122.png)
...
![image123.png](../../../static/img/ccp/user-guides/admin/image123.png)
...
![image124.png](../../../static/img/ccp/user-guides/admin/image124.png)
...
![image125.png](../../../static/img/ccp/user-guides/admin/image125.png)
...
![image126.png](../../../static/img/ccp/user-guides/admin/image126.png)

- The **Image** sub-tab shows the source software stack used to create the virtual machine.

![image127.png](../../../static/img/ccp/user-guides/admin/image127.png)
...
![image128.png](../../../static/img/ccp/user-guides/admin/image128.png)
...
![image129.png](../../../static/img/ccp/user-guides/admin/image129.png)
...
![image130.png](../../../static/img/ccp/user-guides/admin/image130.png)
...
![image131.png](../../../static/img/ccp/user-guides/admin/image131.png)
...
![image132.png](../../../static/img/ccp/user-guides/admin/image132.png)


### Compute Snapshots

CCP Snapshots help you to take backups of your virtual machines and capture their state at a specific time, enabling easy restoration or replication, ensuring data protection, and simplifying recovery processes.

Snapshots capture a VM's state at a specific moment, enabling quick reversion as a backup mechanism. Unlike time-consuming full VM backups, incremental snapshots taken at intervals efficiently track changes. CCP compute snapshots also simplify creating multiple test environments from one VM, letting developers and testers swiftly revert to a clean state after testing configurations or updates.
...
![image133.png](../../../static/img/ccp/user-guides/admin/image133.png)

![image134.png](../../../static/img/ccp/user-guides/admin/image134.png)

![image135.png](../../../static/img/ccp/user-guides/admin/image135.png)
...
![image136.png](../../../static/img/ccp/user-guides/admin/image136.png)
...
![image137.png](../../../static/img/ccp/user-guides/admin/image137.png)
...
![image138.png](../../../static/img/ccp/user-guides/admin/image138.png)
...
![image139.png](../../../static/img/ccp/user-guides/admin/image139.png)
...
![image140.png](../../../static/img/ccp/user-guides/admin/image140.png)
...
![image141.png](../../../static/img/ccp/user-guides/admin/image141.png)
...
![image142.png](../../../static/img/ccp/user-guides/admin/image142.png)
...
![image143.png](../../../static/img/ccp/user-guides/admin/image143.png)
...
**Backend:** Specify the provider, such as the **CCP Virtual Machine Provider**.
...
![image144.png](../../../static/img/ccp/user-guides/admin/image144.png)
...
![image145.png](../../../static/img/ccp/user-guides/admin/image145.png)
...
![image146.png](../../../static/img/ccp/user-guides/admin/image146.png)
...
![image147.png](../../../static/img/ccp/user-guides/admin/image147.png)

![image148.png](../../../static/img/ccp/user-guides/admin/image148.png)
...
![image149.png](../../../static/img/ccp/user-guides/admin/image149.png)

![image150.png](../../../static/img/ccp/user-guides/admin/image150.png)
...
![image151.png](../../../static/img/ccp/user-guides/admin/image151.png)

![image152.png](../../../static/img/ccp/user-guides/admin/image152.png)
...
![image153.png](../../../static/img/ccp/user-guides/admin/image153.png)


### Object Storage

Object storage is a data storage architecture that manages data as distinct units, called objects, rather than as blocks or files. Fluid CCP's object storage helps you to create a bucket. Buckets are the basic containers that store your data in the cloud. Everything that you store in the cloud storage service is contained in a bucket. You can use buckets to organize your data and control access to your data. Buckets have unique names that all users of the cloud storage service share.
...
![image154.png](../../../static/img/ccp/user-guides/admin/image154.png)
...
![image155.png](../../../static/img/ccp/user-guides/admin/image155.png)

![image156.png](../../../static/img/ccp/user-guides/admin/image156.png)
...
![image157.png](../../../static/img/ccp/user-guides/admin/image157.png)

![image158.png](../../../static/img/ccp/user-guides/admin/image158.png)
...
![image159.png](../../../static/img/ccp/user-guides/admin/image159.png)
...
![image160.png](../../../static/img/ccp/user-guides/admin/image160.png)
...
![image161.png](../../../static/img/ccp/user-guides/admin/image161.png)
...
![image162.png](../../../static/img/ccp/user-guides/admin/image162.png)

![image163.png](../../../static/img/ccp/user-guides/admin/image163.png)

![image164.png](../../../static/img/ccp/user-guides/admin/image164.png)

![image165.png](../../../static/img/ccp/user-guides/admin/image165.png)
...
![image168.png](../../../static/img/ccp/user-guides/admin/image168.png)

![image169.png](../../../static/img/ccp/user-guides/admin/image169.png)
...
![image170.png](../../../static/img/ccp/user-guides/admin/image170.png)

![image171.png](../../../static/img/ccp/user-guides/admin/image171.png)
...
![image172.png](../../../static/img/ccp/user-guides/admin/image172.png)

![image173.png](../../../static/img/ccp/user-guides/admin/image173.png)

![image174.png](../../../static/img/ccp/user-guides/admin/image174.png)

![image175.png](../../../static/img/ccp/user-guides/admin/image175.png)

![image176.png](../../../static/img/ccp/user-guides/admin/image176.png)

![image177.png](../../../static/img/ccp/user-guides/admin/image177.png)

![image178.png](../../../static/img/ccp/user-guides/admin/image178.png)

![image179.png](../../../static/img/ccp/user-guides/admin/image179.png)
...
![image180.png](../../../static/img/ccp/user-guides/admin/image180.png)

![image181.png](../../../static/img/ccp/user-guides/admin/image181.png)
...
![image182.png](../../../static/img/ccp/user-guides/admin/image182.png)

![image183.png](../../../static/img/ccp/user-guides/admin/image183.png)
...
![image184.png](../../../static/img/ccp/user-guides/admin/image184.png)

![image185.png](../../../static/img/ccp/user-guides/admin/image185.png)

![image186.png](../../../static/img/ccp/user-guides/admin/image186.png)
...
![image187.png](../../../static/img/ccp/user-guides/admin/image187.png)

![image188.png](../../../static/img/ccp/user-guides/admin/image188.png)
...
![image189.png](../../../static/img/ccp/user-guides/admin/image189.png)
...
![image190.png](../../../static/img/ccp/user-guides/admin/image190.png)
...
![image191.png](../../../static/img/ccp/user-guides/admin/image191.png)
...
![image192.png](../../../static/img/ccp/user-guides/admin/image192.png)

![image193.png](../../../static/img/ccp/user-guides/admin/image193.png)

![image194.png](../../../static/img/ccp/user-guides/admin/image194.png)
...
![image195.png](../../../static/img/ccp/user-guides/admin/image195.png)
...
![image196.png](../../../static/img/ccp/user-guides/admin/image196.png)
...
![image197.png](../../../static/img/ccp/user-guides/admin/image197.png)

![image198.png](../../../static/img/ccp/user-guides/admin/image198.png)
...
![image199.png](../../../static/img/ccp/user-guides/admin/image199.png)
...
![image200.png](../../../static/img/ccp/user-guides/admin/image200.png)

![image201.png](../../../static/img/ccp/user-guides/admin/image201.png)

Click on three dots to update, map region, un-map region, and deactivate availability zone.

![image202.png](../../../static/img/ccp/user-guides/admin/image202.png)
...
![image203.png](../../../static/img/ccp/user-guides/admin/image203.png)
...
![image204.png](../../../static/img/ccp/user-guides/admin/image204.png)
...
![image205.png](../../../static/img/ccp/user-guides/admin/image205.png)
...
![image206.png](../../../static/img/ccp/user-guides/admin/image206.png)
...
![image207.png](../../../static/img/ccp/user-guides/admin/image207.png)
...
![image208.png](../../../static/img/ccp/user-guides/admin/image208.png)
...
![image209.png](../../../static/img/ccp/user-guides/admin/image209.png)

![image210.png](../../../static/img/ccp/user-guides/admin/image210.png)
